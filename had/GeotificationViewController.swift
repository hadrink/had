...
class GeotificationsViewController: UIViewController/*, AddGeotificationsViewControllerDelegate*/, MKMapViewDelegate, CLLocationManagerDelegate {
        ...
        if annotation is Geotification {
            ...
            if annotationView == nil {
               ...
               /* annotationView?.canShowCallout = true
                ...
                removeButton.setImage(UIImage(named: "settings")!, forState: .Normal)
    ...
    func addRadiusOverlayForGeotification(geotification: Geotification) {
        ...
        print("Geotification Radius \(geotification.radius)")
    }
    ...
    func addRegion()
    {
        ...
        let coordinateTaff : CLLocationCoordinate2D = CLLocationCoordinate2D(latitude: CLLocationDegrees(48.369160), longitude: CLLocationDegrees(3.996089))
        let coordinateHome : CLLocationCoordinate2D = CLLocationCoordinate2D(latitude: CLLocationDegrees(48.371214), longitude: CLLocationDegrees(3.993659))
        ...
        addGeotification(geotificationTaff)
        addGeotification(geotificationHome)
